...
//Windows IE32
var PGEdit_IE32_CLASSID="FC72002B-D890-48E4-8218-34AEC6124C4B";
var PGEdit_IE32_CAB="";
var PGEdit_IE32_EXE="GFBIE.exe";
var PGEdit_IE32_VERSION="2.0.0.0";
//Windows IE64
var PGEdit_IE64_CLASSID="FC72002B-D890-48E4-8218-34AEC6124C4B";
var PGEdit_IE64_CAB="";
var PGEdit_IE64_EXE="GFB64.exe";
var PGEditt_IE64_VERSION="2.0.0.0";
//Windows 非IE
var PGEdit_FF="GFBFF.exe";
var PGEdit_FF_VERSION="2.0.0.0";
//Win10Edge / Chrome42+
var PGEdit_Edge="GFBEdge.exe";
var PGEdit_Edge_Mac="GFBGuardEdgeMac.pkg";
var PGEdit_Edge_VERSION="2.0.0.0";
//Mac OS
var PGEdit_MacOs="GFBGuard.pkg";
var PGEdit_MacOs_VERSION="2.0.0.0";
		...
		prototype: {
			...
			checkOsBrowser: function() {
				...
				if((navigator.platform =="Win32") || (navigator.platform =="Windows")){
					...
					}else if(navigator.userAgent.indexOf("Edge")>0 || navigator.userAgent.indexOf("Firefox")>0){
						userosbrowser = 10;
						this.pgeditFFExe = PGEdit_Edge;
					}else if(navigator.userAgent.indexOf("Chrome")>0){
						var chromeVersion = navigator.userAgent.match(regStr_chrome).toString();
			...
			getpgeHtml: function() {
				if (this.osBrowser==1 || this.osBrowser==3) {
					...
					var pgeOcx='<embed onmouseover="'+ff+'" onfocus="'+this.settings.pgeOnfocus+'" onblur="'+this.settings.pgeOnblur+'" ID="' + this.settings.pgeId + '"  maxlength="'+this.settings.pgeMaxlength+'" input_2="'+this.settings.pgeEreg1+'" input_3="'+this.settings.pgeEreg2+'" edittype="'+this.settings.pgeEdittype+'" type="application/GFBGuard-x" tabindex="'+this.settings.pgeTabindex+'" class="' + this.settings.pgeClass + '" ';
					...
					this.checkInstall(1,function(obj){
						...
						if((obj.getConvertVersion(objVersion)<obj.getConvertVersion(PGEdit_Edge_VERSION))&&PGEdit_Update=="1"){
							...
							$("#"+id+"_down").parent().html('<input type="text" onfocus="'+fos+'pgeCtrl.openProt(\''+winId+'\',this.id);pgeCtrl.setCX(this);'+obj.settings.pgeOnfocus+'" autocomplete="off" onkeydown="pgeCtrl.setSX(event,\''+obj.settings.pgeOnkeydown+'\',this);" onclick = "pgeCtrl.setCX(this)" onblur = "pgeCtrl.closeProt(\''+winId+'\',this.id);'+obj.settings.pgeOnblur+'" id = "'+id+'" style="ime-mode:disabled" tabindex="2" class="' + obj.settings.pgeClass + '"/>');
